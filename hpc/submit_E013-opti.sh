...
ID="E013-opti"
COMMON_IN="--id ${ID} --algorithm sNES --optimize-sigma per-weight --env-name MNIST --model MNISTNet --lr 0.05 --cov-lr 0.05 --perturbations 100 --max-generations 5000 --batch-size 1000 --safe-mutation SUM --chkpt-int 1200 --lr-scheduler ExponentialLR --gamma 1"
declare -a INPUTS=(
